...
#determine the file name of each algorithm for iid case
...
plt.legend()
plt.savefig('MSE_IID_sparsity_3', dpi=200)

#determine the file name of each algorithm for non-iid case
