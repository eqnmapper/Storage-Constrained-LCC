...
#list of cases of decompositions
cases = ['IID','non_IID']
...
for case in cases:
  ...
  #determine the file name of each algorithm for given case

  data_paths = []
  for alg in used_algorithms:
      data_paths.append(f'Target_Wiring_UNN_Constr_Quant_C_{alg}_sparsity_3_{case}.npz')
