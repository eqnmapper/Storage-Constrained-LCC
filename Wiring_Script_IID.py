...
for alg in used_algorithms:
    ...
    np.savez_compressed(f'Target_Wiring_UNN_Constr_Quant_C_{alg.__name__}_not_codebook_weighted_sparsity_{sparsity}_IID.npz',Wiring_Mats=Wiring_Mats,Target_Mats=Target_Mats)
